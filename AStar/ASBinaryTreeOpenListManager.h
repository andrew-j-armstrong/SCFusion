...
class CASBinaryTreeOpenListManager
{
public:
	CASBinaryTreeOpenListManager() {}
...
template<typename TNode, typename TCost>
void CASBinaryTreeOpenListManager<TNode, TCost>::Insert(TNode *node)
{
...
template<typename TNode, typename TCost>
void CASBinaryTreeOpenListManager<TNode, TCost>::ReSort(TNode *node)
{
